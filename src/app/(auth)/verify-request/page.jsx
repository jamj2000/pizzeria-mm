...
export default function VerifyRequestPage() {
  return (
    <div className="flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full relative bg-linear-to-b from-white to-zinc-50 dark:from-zinc-950 dark:to-zinc-900/50">
        {/* Decoración de fondo */}
        ...
        <div className="relative bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl rounded-4xl shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] dark:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] p-10 text-center border border-white/50 dark:border-zinc-800/50">
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 bg-orange-400 rounded-full blur-xl opacity-20 animate-pulse" />
              <div className="relative p-5 bg-linear-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/10 rounded-2xl shadow-inner">
